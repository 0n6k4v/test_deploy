...
from schemas.user import UserCreate, UserUpdate, UserPermissionCreate
...
async def create_user(db: AsyncSession, user: UserCreate):
    ...
    db_user = User(
        ...
        email=user.email,
        password=user.password,  # PostgreSQL จะเข้ารหัสให้ด้วย crypt function ผ่าน Trigger
    ...
    if user.permissions:
        for permission_type in user.permissions:
...
async def update_user(db: AsyncSession, user_id: int, user_update: UserUpdate):
    ...
    # No need to hash password here as PostgreSQL will handle it via trigger
